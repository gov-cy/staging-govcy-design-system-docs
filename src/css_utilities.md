...
| Utility           | Usage                                                                                                                                                              | Description                                                                                                                                                                                                                                                                                                                                                                                                            | Example                                                                                                                        |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| **govcy-margin**  | `govcy-m-*`<br /><br /> `govcy-mx-*`<br /><br /> `govcy-my-*`<br /><br /> `govcy-mt-*`<br /><br /> `govcy-mb-*` <br /><br /> `govcy-mr-*`<br /><br /> `govcy-ml-*` | Change the margin radius of an element. <br />`govcy-m` changes margin in all directions, <br />`govcy-mx` changes margin left and right, <br />`govcy-my` changes margin top and bottom, <br />`govcy-mt` changes margin top, <br />`govcy-mb` changes margin bottom, <br />`govcy-ml` changes margin left, <br />`govcy-mr` changes margin right <br /><br /> * can have values `0` - `16`, `20` and `auto`.         | `<div class="govcy-m-2"></div>` <br /><br /> `<div class="govcy-mx-1"></div>` <br /><br /> `<div class="govcy-mt-auto"></div>` |
| **govcy-padding** | `govcy-p-*`<br /><br /> `govcy-px-*`<br /><br /> `govcy-py-*`<br /><br /> `govcy-pt-*`<br /><br /> `govcy-pb-*` <br /><br /> `govcy-pr-*`<br /><br /> `govcy-pl-*` | Change the padding radius of an element. <br />`govcy-p` changes padding in all directions, <br />`govcy-px` changes padding left and right, <br />`govcy-py` changes padding top and bottom, <br />`govcy-pt` changes padding top, <br />`govcy-pb` changes padding bottom, <br />`govcy-pl` changes padding left, <br />`govcy-pr` changes padding right <br /><br /> * can have values `0` - `16`, `20` and `auto`. | `<div class="govcy-p-2"></div>` <br /><br /> `<div class="govcy-px-1"></div>` <br /><br /> `<div class="govcy-pt-5"></div>`    |
...
| **govcy-gap**       | `govcy-gap-*`  | Change the gaps (gutters) between rows and columns.<br /><br /> * can have values `0` - `16`, `20`                                                                                                        | `<div class="govcy-gap-2"></div>`     |
