...
| **Before main**  | `<section class="govcy-container" id="beforeMainContainer"> </section>`            | To be used to render the content before the `<main>` (i.e. ==back link==, ==breadcrumbs== and ==phase banner== only ) .                                                          |
| **Main**         | `<main class="govcy-container" id="mainContainer"> </main>`                        | To be used to render the service/website content (i.e. ==question page==). This section can have one of the layouts described in the ==layout section==.                         |
